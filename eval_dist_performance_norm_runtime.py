...
def plot(names, object_labels, group_labels, data, lengend, output_path,
    ...
    for it, name in enumerate(names):
        ...
        for i in range(len(object_labels)):
            ...
            missing_indices = np.where(plot_y == 0)[0]
...
def draw_figure(input_path, output_path, min_ylim, max_ylim, ystep):
    ...
    output_path = "figures/" + "eval_dist_performance_sage_norm_runtime.pdf"
...
def draw_figure2(input_path, output_path, min_ylim, max_ylim, ystep):
    ...
    output_path = "figures/" + "eval_dist_performance_gat_norm_runtime.pdf"
    plot(names, labels, header, all_data, None, output_path, min_ylim,
         max_ylim, ystep, "GAT")


if __name__ == "__main__":
    draw_figure("data/eval_dist_performance_sage_norm_runtime.csv", "figures",
                [0, 0, 0, 0], [8, 20, 12, 10], [4, 10, 6, 5])
    draw_figure2("data/eval_dist_performance_gat_norm_runtime.csv", "figures",
                 [0, 0, 0, 0], [8, 20, 12, 10], [4, 10, 6, 5])
